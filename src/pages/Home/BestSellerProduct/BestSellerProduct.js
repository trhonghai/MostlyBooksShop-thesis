  ...
  return (
    <div className="mt-10 flex justify-center">
      <div className="w-10/12 overflow-hidden">
        <h2 class="text-2xl text-left pl-10 font-bold text-[#327580] sm:text-3xl">
        ...
        <Carousel responsive={responsive}>
            ...
            <div class="group p-5 border shadow-lg rounded-lg border shadow-lg h-full ">
              <div class="overflow-hidden  aspect-w-1 aspect-h-1">
                <img
                  ...
                  src="https://salt.tikicdn.com/cache/750x750/ts/product/03/03/07/3fbe7cc39c9fe08b308274a03099c1c1.jpg.webp"
                  alt=""
                />
              </div>
          ...
          <div className="w-full p-5 h-full ">
            <div class="relative group p-5 border shadow-lg  rounded-lg h-full">
              <div class="overflow-hidden aspect-w-1 aspect-h-1">
                <img
                  class="object-cover w-full h-64 transition-all duration-300 group-hover:scale-125"
                  src="https://salt.tikicdn.com/cache/750x750/ts/product/b4/f0/81/5d5e4a26cb029fdecd04e0c30cbef17a.jpg.webp"
                  alt=""
                />
              </div>
          ...
          <div className="p-5 h-full">
            <div className="relative group p-5 border shadow-lg rounded-lg h-full">
              <div class="overflow-hidden aspect-w-1 aspect-h-1">
                <img
                  class="object-cover w-full h-64 transition-all duration-300 group-hover:scale-125"
                  src="https://salt.tikicdn.com/cache/w1200/ts/product/5e/18/24/2a6154ba08df6ce6161c13f4303fa19e.jpg"
                  alt=""
                />
              </div>
              <div class="absolute left-3 top-3">
          ...
          <div className=" p-5 h-full">
            <div class="relative group p-5 border shadow-lg rounded-lg h-full">
              <div class="overflow-hidden aspect-w-1 aspect-h-1">
                <img
                  class="object-cover w-full h-64 transition-all duration-300 group-hover:scale-125"
                  src="https://salt.tikicdn.com/cache/750x750/ts/product/a9/58/93/c0770a8b8a2848da045459658443336e.png.webp"
                  alt=""
                />
              </div>
              <div class="flex items-start justify-between mt-4 space-x-4">
